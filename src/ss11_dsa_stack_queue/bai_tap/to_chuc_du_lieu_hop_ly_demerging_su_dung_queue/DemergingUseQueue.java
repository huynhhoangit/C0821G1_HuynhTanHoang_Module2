...
public class DemergingUseQueue {
    ...
    public static void main(String[] args) {
        ...
        listPerson.add(new Person("Hanh", "female", "27/07/1996"));
        listPerson.add(new Person("Nham", "male", "19/02/1988"));
        ...
        System.out.println("List Sắp xếp  theo ngày tháng năm sinh là: \n" + listPerson);
